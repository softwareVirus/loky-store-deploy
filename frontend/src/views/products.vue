...
export default {
  ...
  async setup() {
    ...
    const handleDrag = (e) => {
      ...
      if (
        MouseFromBeginOfDivX + 10 >= MinimapRectangleMinimapX / 2 &&
        divWidth - MinimapRectangleMinimapX / 2 > MouseFromBeginOfDivX
      ) {
        dragWrapper.value.style.marginLeft =
          MouseFromBeginOfDivX - MinimapRectangleMinimapX / 2 + 'px'
        dragWrapperCarousel.value.scrollLeft =
          (MouseFromBeginOfDivX - MinimapRectangleMinimapX / 2) * 5
    ...
    function handleWheel(event) {
      ...
      const currentMargin =
        parseInt(
          dragWrapper.value.style.marginLeft === '' ? 0 : dragWrapper.value.style.marginLeft
        ) +
        scrollAmount / 7.5
